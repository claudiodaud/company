...
class RoleIndexCompany extends Component
{
    use WithPagination;
    ...
    public function saveRole()
    {
        ...
        $role->companies()->sync($this->companyId);
    ...
    {        
        return (new CompanyRolesExport(['search' => $this->search], ['companyId' => $this->companyId], ['active' => $this->active]))->download('roles.xlsx'); 
    }
